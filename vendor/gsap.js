...
!(function (t, e) {
    ...
    return (
          ...
          this._onUpdate && !e && At(this, 'onUpdate', !0),
            ((v === m && this._tTime >= this.totalDuration()) || (!v && _)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                this._lock ||
                ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || za(this, 1), e || (t < 0 && !_) || (!v && !_ && m) || (At(this, v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
        }
        return this;
      }),
      ...
      (e.getTweensOf = function getTweensOf(e, r) {
        for (var i, n = [], a = Ot(e), s = this._first, o = t(r); s; )
          s instanceof Zt ? la(s._targets, a) && (o ? (!Nt || (s._initted && s._ts)) && s.globalTime(0) <= r && s.globalTime(s.totalDuration()) > r : !r || s.isActive()) && n.push(s) : (i = s.getTweensOf(a, r)).length && n.push.apply(n, i), (s = s._next);
        return n;
      }),
            ...
            function _addComplexStringPropTween(t, e, r, i, n, a, s) {
              ...
              for (_.b = r, _.e = i, r += '', (d = ~(i += '').indexOf('random(')) && (i = ob(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || []; (o = it.exec(i)); )
                (l = o[0]),
                  ...
                  l !== u[g++] && ((c = parseFloat(u[g - 1]) || 0), (_._pt = { _next: _._pt, p: f || 1 === g ? f : ',', s: c, c: '=' === l.charAt(1) ? ka(c, l) - c : parseFloat(l) - c, m: h && h < 4 ? Math.round : 0 }), (m = it.lastIndex));
  ...
  function xe(t, e, r) {
    var i,
      ...
      l = we({}, r._gsap),
      f = r.style;
    for (n in (l.svg ? ((a = r.getAttribute('transform')), r.setAttribute('transform', ''), (f[dr] = e), (i = kr(r, 1)), Xd(r, dr), r.setAttribute('transform', a)) : ((a = getComputedStyle(r)[dr]), (f[dr] = e), (i = kr(r, 1)), (f[dr] = a)), ar))
      ...
      return (
        ...
        I.translate &&
          (('none' === I.translate && 'none' === I.scale && 'none' === I.rotate) ||
            (F[dr] =
              ('none' !== I.translate ? 'translate3d(' + (I.translate + ' 0 0').split(' ').slice(0, 3).join(', ') + ') ' : '') + ('none' !== I.rotate ? 'rotate(' + I.rotate + ') ' : '') + ('none' !== I.scale ? 'scale(' + I.scale.split(' ').join(',') + ') ' : '') + ('none' !== I[dr] ? I[dr] : '')),
        ...
        m !== wr &&
          ...
          6 === m.length
            ...
            : ((R = m[6]),
              ...
              (a = m[14]),
              (h = (g = ur(R, E)) * sr),
              g && ((O = k * (v = Math.cos(-g)) + C * (y = Math.sin(-g))), (P = M * v + S * y), (A = R * v + E * y), (C = k * -y + C * v), (S = M * -y + S * v), (E = R * -y + E * v), (z = D * -y + z * v), (k = O), (M = P), (R = A)),
              (l = (g = ur(-w, E)) * sr),
        ...
        for (c in (Fe || Sd(), (this.styles = this.styles || Md(t)), (b = this.styles.props), (this.tween = i), e))
          if ('autoRound' !== c && ((o = e[c]), !pt[c] || !ac(c, e, i, n, t, a)))
            if (((l = typeof o), (f = br[c]), 'function' === l && (l = typeof (o = o.call(i, n, t, a))), 'string' === l && ~o.indexOf('random(') && (o = ob(o)), f)) f(this, t, c, o, i) && (T = 1);
              ...
              (s = (getComputedStyle(t).getPropertyValue(c) + '').trim()), (o += ''), (Dt.lastIndex = 0), Dt.test(s) || ((d = Ya(s)), (p = Ya(o))), p ? d !== p && (s = _d(t, c, s, p) + p) : d && (o += d), this.add(x, 'setProperty', s, o, n, a, 0, 0, c), w.push(c), b.push(c, 0, x[c]);
            else if ('undefined' !== l) {
              if (
                (k && c in k ? ((s = 'function' == typeof k[c] ? k[c].call(i, n, t, a) : k[c]), r(s) && ~s.indexOf('random(') && (s = ob(s)), Ya(s + '') || (s += q.units[c] || Ya(yr(t, c)) || ''), '=' === (s + '').charAt(1) && (s = yr(t, c))) : (s = yr(t, c)),
                (h = parseFloat(s)),
                (_ = 'string' === l && '=' === o.charAt(1) && o.substr(0, 2)) && (o = o.substr(2)),
                (u = parseFloat(o)),
                c in cr &&
                  ('autoAlpha' === c && (1 === h && 'hidden' === yr(t, 'visibility') && u && (h = 0), b.push('visibility', 0, x.visibility), Yd(this, x, 'visibility', h ? 'inherit' : 'hidden', u ? 'inherit' : 'hidden', !u)),
                  'scale' !== c && 'transform' !== c && ~(c = cr[c]).indexOf(',') && (c = c.split(',')[0])),
                (m = c in ar))
              )
                if ((this.styles.save(c), g || (((v = t._gsap).renderTransform && !e.parseTransform) || kr(t, e.parseTransform), (y = !1 !== e.smoothOrigin && v.smooth), ((g = this._pt = new _e(this._pt, x, dr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)), 'scale' === c))
